 ...
 */ 
 ...
 $(document).ready(function() {
    ...
    calendar = $('#calendar').fullCalendar({
        ...
        selectHelper: true,
        events: {
            url: "controller/events.php?dep="+dependencia,
            cache: true
        },
        eventColor: '#022a50',
        /*
...
function actualizarCalendario2(){
    ...
    $("#calendar").fullCalendar('removeEventSource', "controller/events.php?dep="+dependencia+"&emp="+ empleado);
...
//    $('#calendar').fullCalendar('refetchEvents');
     // elimina eventos del calendario
    $("#calendar").fullCalendar("addEventSource", "controller/events.php?dep="+dependencia+"&emp="+empleado); // setea
...
function cargarTgxGoc() {
    ...
    var url="index.php?page=rolesturnos&accion=tgxgoc"    
    $.ajax({
        type: "POST",
        url: url,
        data: {
...
function capturarmes() {
    ...
    var url="index.php?page=rolesturnos&accion=oestado" 
    $.ajax({
        type: "POST",
        url: url,
        data: {
...
function capturarobservames() {
    ...
    var ano_int = date.getFullYear();
    var month_int = month_int0+1;
    var url="index.php?page=rolesturnos&accion=oobservacion" 
    $.ajax({
        type: "POST",
        url: url,
        data: {
...
function obtenerdepartamento() {
    ...
    var url="index.php?page=rolesturnos&accion=odepa" 
    $.ajax({
        type: "POST",
        url: url,
        data: {
 ...
 */
 ...
 function cargarEmpleadosxGrupo(){
    ...
    var url="index.php?page=rolesturnos&accion=cargaremp"
    $.ajax({   
        type: "POST",
        url:url,
        data:{
...
function consultarrolxdepxtgxfecha(){
    ...
    var url="index.php?page=rolesturnos&accion=verificaRolxTg"
    $.ajax({   
        type: "POST",
        url:url,
        data:{
 ...
 */
 ...
 function cargarDatosRoles(fecha,dependencia){
    var url="index.php?page=rolesturnos&accion=cargarroles"
    $.ajax({   
        type: "POST",
        url:url,
        data:{
...
function consultarrolxdepxtgxfechaxEmp(){
    var guardia = $('select[name=guardia]').val();
    var empleado= $('select[name=empleado]').val();
    var url="index.php?page=rolesturnos&accion=verificaRolxTgxEmp"
    $.ajax({   
        type: "POST",
        url:url,
        data:{
 ...
 */
 ...
 function insertarNuevoRol(){
    ...
    var url="index.php?page=rolesturnos&accion=insertar"
    $.ajax({   
        type: "POST",
        url:url,
        data:{
...
function insertarNuevoRol2(){
    ...
    var url="index.php?page=rolesturnos&accion=insertar2"
    $.ajax({   
        type: "POST",
        url:url,
        data:{
...
function insertarNuevoRol3(){
    ...
    var url="index.php?page=rolesturnos&accion=insertar3"
    $.ajax({   
        type: "POST",
        url:url,
        data:{
 ...
 */
 ...
 function eliminarRoles(cod){
    ...
    if(a == true){
        var url="index.php?page=rolesturnos&accion=eliminar"
        $.ajax({   
            type: "POST",
            url:url,
            data:{
...
function cargarDetalles(cod, fila) {
    var codigo = cod;
    roldeturno = codigo;
    var url="index.php?page=rolesturnos&accion=cargardetalles"
    $.ajax({   
        type: "POST",
        url:url,
        data:{
...
function insertarDetalles(){
    ...
    var url="index.php?page=rolesturnos&accion=insertardet"
    $.ajax({   
        type: "POST",
        url:url,
        data:{
 ...
 */
 ...
 function eliminarDetalles(rol, emp){
    var a = confirm('Esta seguro de eliminar?');
    if(a == true){
        var url="index.php?page=rolesturnos&accion=eliminardet"
        $.ajax({   
            type: "POST",
            url:url,
            data:{
...
function eliminarDetalles2(){
    ...
    //if(a == true){
        ...
        var guardia = $('select[name=guardia]').val();
        var empleado= $('select[name=empleado]').val();
        var url="index.php?page=rolesturnos&accion=eliminardet2"
        $.ajax({   
            type: "POST",
            url:url,
            data:{
 ...
 */
 ...
 function verProgramacion(){
    ...
    window.window.open("index.php?page=rolesturnos&accion=program&d="+dep+"&m="+month+"&a="+year);
}