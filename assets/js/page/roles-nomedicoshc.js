 ...
 */ 
 ...
 $(document).ready(function() {
    ...
    calendar = $('#calendar').fullCalendar({
        ...
        selectHelper: true,
        events: {
            url: "controller/eventshc.php?dep="+dependencia,
            cache: true
        },
        eventColor: '#022a50',
        /*
...
function actualizarCalendario(){
    $("#calendar").fullCalendar('removeEventSource', "controller/events.php?dep="+dependencia);
    dependencia = $('input[name=dep_id]').val();
//    $('#calendar').fullCalendar('refetchEvents');
     // elimina eventos del calendario
    $("#calendar").fullCalendar("addEventSource", "controller/events.php?dep="+dependencia); // setea
}

function actualizarCalendario2(){
    $('.fc-corner-left').hide();
    $('.fc-corner-right').hide();
    $("#calendar").fullCalendar('removeEventSource', "controller/eventshc.php?dep="+dependencia+"&emp="+ empleado);
    empleado = $('select[name=empleado]').val();
    dependencia = $('input[name=dep_id]').val();
    
//    $('#calendar').fullCalendar('refetchEvents');
     // elimina eventos del calendario
    $("#calendar").fullCalendar("addEventSource", "controller/eventshc.php?dep="+dependencia+"&emp="+empleado); // setea
...
function cargarTgxGoc() {
    ...
    var url="index.php?page=rolnomedicoshc&accion=tgxgoc"    
    $.ajax({
        type: "POST",
        url: url,
        data: {
...
//     var url="index.php?page=rolnomedicoshc&accion=oestado" 
//     $.ajax({
//         type: "POST",
//         url: url,
//         data: {
...
//     var ano_int = date.getFullYear();
//     var month_int = month_int0+1;
//     var url="index.php?page=rolnomedicoshc&accion=oobservacion" 
//     $.ajax({
//         type: "POST",
//         url: url,
//         data: {
 ...
 */
 ...
 function cargarEmpleadosxGrupo(){
    ...
    var url="index.php?page=rolnomedicoshc&accion=cargaremp"
    $.ajax({   
        type: "POST",
        url:url,
        data:{
...
function consultarrolxdepxtgxfecha(){
    ...
    var url="index.php?page=rolnomedicoshc&accion=verificaRolxTg"
    $.ajax({   
        type: "POST",
        url:url,
        data:{
 ...
 */
 ...
 function cargarDatosRoles(fecha,dependencia){
    var url="index.php?page=rolnomedicoshc&accion=cargarroles"
    $.ajax({   
        type: "POST",
        url:url,
        data:{
...
function consultarrolxdepxtgxfechaxEmp(){
    var guardia = $('select[name=guardia]').val();
    var empleado= $('select[name=empleado]').val();
    var url="index.php?page=rolnomedicoshc&accion=verificaRolxTgxEmp"
    $.ajax({   
        type: "POST",
        url:url,
        data:{
 ...
 */
 ...
 function insertarNuevoRol(){
    ...
    var url="index.php?page=rolnomedicoshc&accion=insertar"
    $.ajax({   
        type: "POST",
        url:url,
        data:{
...
function insertarNuevoRol2(){
    ...
    var url="index.php?page=rolnomedicoshc&accion=insertar2"
    $.ajax({   
        type: "POST",
        url:url,
        data:{
...
function insertarNuevoRol3(){
    ...
    //var nomguardia = $('select[name=guardia]').html();
    var nomguardia = $("#guardia option:selected").html();
    ...
    // var url="index.php?page=rolnomedicoshc&accion=insertar3"
    var url="index.php?page=rolnomedicoshc&accion=insertar4"
    $.ajax({   
        type: "POST",
        url:url,
        data:{
 ...
 */
 ...
 function eliminarRoles(cod){
    ...
    if(a == true){
        var url="index.php?page=rolnomedicoshc&accion=eliminar"
        $.ajax({   
            type: "POST",
            url:url,
            data:{
...
function cargarDetalles(cod, fila) {
    var codigo = cod;
    roldeturno = codigo;
    var url="index.php?page=rolnomedicoshc&accion=cargardetalles"
    $.ajax({   
        type: "POST",
        url:url,
        data:{
...
function insertarDetalles(){
    ...
    var url="index.php?page=rolnomedicoshc&accion=insertardet"
    $.ajax({   
        type: "POST",
        url:url,
        data:{
 ...
 */
 ...
 function eliminarDetalles(rol, emp){
    var a = confirm('Esta seguro de eliminar?');
    if(a == true){
        var url="index.php?page=rolnomedicoshc&accion=eliminardet"
        $.ajax({   
            type: "POST",
            url:url,
            data:{
...
function eliminarDetalles2(){
    ...
    //if(a == true){
        ...
        var guardia = $('select[name=guardia]').val();
        var empleado= $('select[name=empleado]').val();
        var url="index.php?page=rolnomedicoshc&accion=eliminardet2"
        $.ajax({   
            type: "POST",
            url:url,
            data:{
 ...
 */
 ...
 function verProgramacion(){
    ...
    window.window.open("index.php?page=rolnomedicoshc&accion=program&d="+dep+"&m="+month+"&a="+year);
}